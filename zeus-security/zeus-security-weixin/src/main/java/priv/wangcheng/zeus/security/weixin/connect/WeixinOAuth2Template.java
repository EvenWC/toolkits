 ...
 * 
 * @author wangcheng
 * @version $Id: WeixinOAuth2Template.java, v0.1 2019/5/26 12:39 wangcheng Exp $$
 */
public class WeixinOAuth2Template extends OAuth2Template {
	...
	private AccessGrant getAccessToken(StringBuilder accessTokenRequestUrl) {
		...
		Map<String, Object> result = JsonUtils.readValue(response,Map.class);
		
		//返回错误码时直接返回空
		if(StringUtils.hasText(MapUtils.getString(result,"errcode"))){
