 ...
 * @author wangcheng
 * @version $Id: ZeusJdbcUsersConnectionRepository.java, v0.1 2019/5/26 12:39 wangcheng Exp $$
 */
public class ZeusJdbcUsersConnectionRepository implements UsersConnectionRepository {
    ...
    public ZeusJdbcUsersConnectionRepository(DataSource dataSource, ConnectionFactoryLocator connectionFactoryLocator, TextEncryptor textEncryptor) {
    ...
    public ConnectionRepository createConnectionRepository(String userId) {
        ...
        return new ZeusJdbcConnectionRepository(userId, jdbcTemplate, connectionFactoryLocator, textEncryptor, tablePrefix);
    }
