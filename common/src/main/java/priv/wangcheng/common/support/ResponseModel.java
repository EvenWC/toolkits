package priv.wangcheng.common.support;
...
/**
 * @author wangcheng
 * @version $Id: ResponseModel.java, v0.1 2019/5/27 22:59 wangcheng Exp $$
 */
public class ResponseModel<T> implements Serializable {
    ...
    public String toString() {
        return "ResponseModel{" + "timestamp=" + timestamp + ", status=" + status + ", message='" + message + '\'' + ", data=" + data + '}';
    }
